...
DECISIONS = (
    "QUESTIONARIO_RESPONDIDO.json", "EDIT_PLAN.json", "EDIT_PLAN_AUTO.json", "EDIT_PLAN_DRAFT.json",
    ...
    "_CONTROLE/AI_CARD_OPERATIONS.json",
    "_CONTROLE/DETERMINISTIC_AUTOEDIT.json",
    ...
    "PACOTE_PARA_IA/V2/EDIT_PLAN_RESPONSE.json",
    "_ENTRADA/EDIT_PLAN_RESPONSE_V2.json", "_CONTROLE/ROTEIRO_IMPORT_SOURCE.json",
