...
python3 "$fr_app_dir/tests/phase2_ai_package_test.py"
...
test -s "$fr_project/PACOTE_PARA_IA/00_NAO_EDITAR_CONTEXTO_PROJETO.md"
test -s "$fr_project/PACOTE_PARA_IA/01_EDITAR_E_DEVOLVER_ROTEIRO_MESTRE.md"
test -s "$fr_project/PACOTE_PARA_IA/02_NAO_EDITAR_MANIFESTO_MEDIA.json"
test -d "$fr_project/PACOTE_PARA_IA/03_NAO_EDITAR_LOTES_DE_PROXIES"
test -s "$fr_project/PACOTE_PARA_IA/04_NAO_EDITAR_INSTRUCOES_PARA_IA.md"
test -s "$fr_project/PACOTE_PARA_IA/05_RESPOSTA_DA_IA_IMPORTAR_AQUI.md"
